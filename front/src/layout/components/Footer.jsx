        ...
        <div className="footerTop">
          ...
          <div className="fotCompany">
            ...
            <ul>
              <li>
                <button
                  onClick={handleExternalLink(
                    "https://play.google.com/store/apps/details?id=az.parkcinema.app&hl=en_US&pli=1"
                  )}
                  href="#"
              ...
              <li>
                <button
                  onClick={handleExternalLink(
                    "https://apps.apple.com/om/app/park-cinema/id1119977600"
                  )}
                  href="#"
                  className="playstore-button"
                >
          ...
          <div className="fotName">
            ...
            <ul>
              <li>
                <FontAwesomeIcon
                  onClick={handleExternalLink(
                    "https://chat.whatsapp.com/KAfqzGzvRET9KWBeP0kzbB"
                  )}
                  className="footicon"
                  icon={faWhatsapp}
                />
              ...
              <li>
                <FontAwesomeIcon
                  onClick={handleExternalLink(
                    "https://www.instagram.com/umudlzde/?igsh=MWNsYzlpZTJ6MjV5Nw%3D%3D"
                  )}
                  className="footicon"
                  icon={faInstagram}
                />
              ...
              <li>
                <FontAwesomeIcon
                  onClick={handleExternalLink(
                    "https://www.facebook.com/umid.elizade.750?mibextid=ZbWKwL"
                  )}
                  className="footicon"
                  icon={faFacebook}
                />
              ...
              <li>
                <FontAwesomeIcon
                  onClick={handleExternalLink(
                    "https://https://t.me/+orkn-5NboT5hM2Yy"
                  )}
                  className="footicon"
                  icon={faTelegram}
                />
          ...
          <div className="fotName">
            ...
            <ul>
              <ul onClick={() => openChat()}>
                <li>
                  <FontAwesomeIcon className="footicon" icon={faComments} />
                </li>
              </ul>
            </ul>
          </div>
